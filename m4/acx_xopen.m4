...
AC_DEFUN([ACX_TRY_COMPILE_XOPEN_SOURCE],
[
 AC_LANG_SAVE
 AC_LANG_CPLUSPLUS
 AC_TRY_COMPILE(
	...
	[$1], [
      ...
      CPPFLAGS="${acx_safe_cppflags}"
    ]
  )
  AC_LANG_RESTORE
])

AC_DEFUN([ACX_CHECK_XOPEN_SOURCE],
[
...
AC_LANG_RESTORE
  ...
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg4_testcode], [-D_XOPEN_SOURCE=4], 400, [XPG4])
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg42_testcode], [-D_XOPEN_SOURE -D_XOPEN_SOURCE_EXTENDED], 420, [XPG4.2])
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg5_testcode], [-D_XOPEN_SOURE=500], 500, [XPG5])
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg52_testcode], [-D_XOPEN_SOURE=520], 520, [XPG5.2])
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg6_testcode], [-D_XOPEN_SOURE=600], 600, [XPG6])
  ACX_TRY_COMPILE_XOPEN_SOURCE([xpg7_testcode], [-D_XOPEN_SOURE=700], 700, [XPG7])
  AS_IF(
    [test "${NEED_DEFINE_XOPEN_SOURCE}" = "1"],
    [AS_IF(
